...
function RoClothes(Player)
	...
	function Function.PartListDefault()
		return {
			...
			["BBC"] = {
				...
				["CFrame"] = CFrame.new(0, -0.9, -0.45, 1, 0, 0, 0, 1, 0, 0, 0, 1),
				["Transparency"] = 1,
				["Material"] = Enum.Material.SmoothPlastic,
				["Color"] = {
					["Tone"] = "Base",
			...
			["BBC Rod"] = {
				...
				["CFrame"] = CFrame.new(-0.077, -0.082, 0.017, 1, 0, 0, 0, 1, 0, 0, 0, 1),
				["CFrame1"] = CFrame.new(0, -0.2, 0.7, 1, 0, 0, 0, 1, 0, 0, 0, 1),
				["Transparency"] = 0,
				["Material"] = Enum.Material.SmoothPlastic,
				["Color"] = {
					["Tone"] = "Base",
			...
			["Left Breast 2"] = {
				...
				["CFrame"] = CFrame.new(-0.00666618347, -0.01826795197, 0.34, 0.922279179, -0.191880912, 0.335533708, 0.0711436272, 0.937517881, 0.340585262, -0.379920751, -0.290244073, 0.878304482),
			...
			["Right Breast 2"] = {
				...
				["Name"] = "Right Breast 2",
				["Size"] = Vector3.new(1.242, 1.252, 0.993),
				["CFrame"] = CFrame.new(-0.02666618347, -0.01826795197, -0.34, 0.922279179, -0.191880912, -0.335533708, 0.0711436272, 0.937517881, -0.340585262, 0.379920751, 0.290244073, 0.878304482),
				--["CFrame"] = CFrame.new(0.360874176, 0.38800168, -0.483547688, -0.36783731, -0.290563017, -0.883328319, -0.0900876448, 0.956592739, -0.27714473, 0.925514758, -0.0223651696, -0.378048182),
				["Transparency"] = 0,
				["Material"] = Enum.Material.SmoothPlastic,
				["MeshId"] = "rbxasset://7220038121.mesh",
	...
	function Function.BBCPhysics(ObjectInstance, Character, Extra, Data)
		if PlayerData[Data].BodyPartPhysics then
			local Torso = Character:FindFirstChild("Torso")
	...
	function Function.CharacterReset(PlayerName)
		...
		if type(PlayerName) ~= "string" and Function.IsCharacter(PlayerName) then
			if Function.TableFind(NPCs, PlayerName) == nil and a == false then 
				return
			else
	...
	function Function.CharacterExecute(Character, Data, bool)
		...
		if Character then
			...
			if PlayerData[Data].ToggleBBC == true then
				local BBC = Function.Weld(PartListData["BBC"], Character, Extra, Data)
				local BBCROD = Function.Weld(PartListData["BBC Rod"], Character, Extra, Data)
				local BBCTIP = Function.Weld(PartListData["BBC Tip"], Character, Extra, Data)
				local BBCBALLS = Function.Weld(PartListData["BBC Balls"], Character, Extra, Data)
				PlayerData[Data].CurrentPartList["Organ"]["BBC"] = BBC
				PlayerData[Data].CurrentPartList["Organ"]["BBCROD"] = BBCROD
				PlayerData[Data].CurrentPartList["Organ"]["BBCTIP"] = BBCTIP
				PlayerData[Data].CurrentPartList["Organ"]["BBCBALLS"] = BBCBALLS
			end
			...
			if DataDetail.BodyPartPhysics then
				...
				if Torso then
					...
					if DataDetail.ToggleBBC == true and PlayerData[Data].CurrentPartList["Organ"]["BBC"] ~= nil then
						Function.SpringCreate(
							PlayerData[Data].CurrentPartList["Organ"]["BBCROD"], 
							PlayerData[Data].CurrentPartList["Organ"]["BBC"], 
							Vector3.new(1,1,1) * 5, 
							Vector3.new(0,0,0), 
							10, 
							0.2, 
						...
						Function.SpringCreate(
							PlayerData[Data].CurrentPartList["Organ"]["BBCBALLS"], 
							PlayerData[Data].CurrentPartList["Organ"]["BBCROD"], 
							Vector3.new(1,1,1) * 5, 
							Vector3.new(0,0,0), 
							10, 
